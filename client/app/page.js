...
import { LoaderIcon, Mail, Lock, LogIn, Eye, EyeOff } from "lucide-react";
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            ...
            <Link href="/register" className="font-semibold text-gray-900 hover:underline hover:text-blue-600 transition-colors">
              Sign up for free
            </Link>
          </p>
        </div>
